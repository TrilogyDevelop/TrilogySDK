...
public:
	...
	char field_6C0[8];
	unsigned __int16 m_nWeaponGunflashAlphaMP1;
	char field_6CA;
	unsigned __int16 m_nWeaponGunflashAlphaMP2;
	CPedIK m_pedIK;
	char field_6F8[12];
	float m_fHealth;
	float m_fMaxHealth;
	...
	char field_9E8[17];
	unsigned __int16 m_nMoneyCount;
	char field_A0C[8];
	char m_nLastWeaponDamage;
	char field_A05[59];
	float m_fRemovalDistMultiplier;
	unsigned __int16 m_wSpecialModelIndex;
	char field_A46[2];
	int field_A48;
	char field_A4C;
	char field_A5D;
